...
![Decision Helper screenshot](./images/screenshot_decision_inputs.png)
...
The full Dashboard tab assembled into one view. Climate snapshot, growing-season indicator, top-5 plantable crops:

![Dashboard composite](./images/dashboard_composite.png)

### Dashboard tab screenshot

What the actual Dashboard tab looks like in the workbook:

![Dashboard tab](./images/screenshot_dashboard.png)
